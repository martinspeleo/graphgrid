...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'imageGraphSeriesLine.label_colour'
        db.add_column(u'graphs_imagegraphseriesline', 'label_colour',
                      self.gf('colorful.fields.RGBColorField')(default='#000000', max_length=7),
                      keep_default=False)

        # Adding field 'imageGraphSeriesLine.line_colour'
        db.add_column(u'graphs_imagegraphseriesline', 'line_colour',
                      self.gf('colorful.fields.RGBColorField')(default='#000000', max_length=7),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'imageGraphSeriesLine.colour'
        raise RuntimeError("Cannot reverse this migration. 'imageGraphSeriesLine.colour' and its values cannot be restored.")
        # Deleting field 'imageGraphSeriesLine.label_colour'
        db.delete_column(u'graphs_imagegraphseriesline', 'label_colour')

        # Deleting field 'imageGraphSeriesLine.line_colour'
        db.delete_column(u'graphs_imagegraphseriesline', 'line_colour')
