...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'imageGraphTimeSeries.left_axis'
        db.add_column(u'graphs_imagegraphtimeseries', 'left_axis',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'imageGraph.central_axis'
        db.delete_column(u'graphs_imagegraph', 'central_axis')


    def backwards(self, orm):
        # Deleting field 'imageGraphTimeSeries.left_axis'
        db.delete_column(u'graphs_imagegraphtimeseries', 'left_axis')

        # Adding field 'imageGraph.central_axis'
        db.add_column(u'graphs_imagegraph', 'central_axis',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
