...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'imageGraphSeries.other_observation_type'
        db.add_column(u'graphs_imagegraphseries', 'other_observation_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='imagegraphseriesother', null=True, to=orm['patients.NumericObservationType']),
                      keep_default=False)

        # Adding field 'imageGraphTimeSeries.label'
        db.add_column(u'graphs_imagegraphtimeseries', 'label',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'imageGraphSeries.other_observation_type'
        db.delete_column(u'graphs_imagegraphseries', 'other_observation_type_id')

        # Deleting field 'imageGraphTimeSeries.label'
        db.delete_column(u'graphs_imagegraphtimeseries', 'label')
