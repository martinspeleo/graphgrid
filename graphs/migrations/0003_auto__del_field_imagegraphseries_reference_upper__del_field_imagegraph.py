...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'imageGraphSeries.reference_upper'
        db.delete_column(u'graphs_imagegraphseries', 'reference_upper')

        # Deleting field 'imageGraphSeries.reference_lower'
        db.delete_column(u'graphs_imagegraphseries', 'reference_lower')


    def backwards(self, orm):
        # Adding field 'imageGraphSeries.reference_upper'
        db.add_column(u'graphs_imagegraphseries', 'reference_upper',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'imageGraphSeries.reference_lower'
        db.add_column(u'graphs_imagegraphseries', 'reference_lower',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)
